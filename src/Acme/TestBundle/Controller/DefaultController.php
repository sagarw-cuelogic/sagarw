...
use Acme\TestBundle\Form\ProfileType;
...
class DefaultController extends Controller
{
    ...
    public function updateProfileAction(Request $request,$id)
    {
        ...
        if($id==null || $session->get('user_id')!=$id)
        {
            return $this->redirect($this->generateUrl('test_profile'));
        }
        else
        {
         ...
         $profile = $em->getRepository('AcmeTestBundle:Registeration')->find($id);
        ...
        if($request->getMethod()=='POST')
        {
            ...
            $em->flush();
            $this->get('session')->getFlashBag()->add('notice', 'Profile updated successfully!');

            }
        }

        }
        return $this->render('AcmeTestBundle:profile:updateprofile.html.twig',array('form'=>$form->createView()));  
    }
